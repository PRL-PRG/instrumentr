...
#' @export
create_variable_lookup_callback <- function(object) {
    UseMethod("create_variable_lookup_callback")
}

#' @export
create_variable_lookup_callback.function <- function(object) {
...
#' @export
create_variable_lookup_callback.externalptr <- function(object) {
