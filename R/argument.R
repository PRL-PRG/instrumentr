...
has_name.instrumentr_argument <- function(object) {
    .Call(C_instrumentr_argument_has_name, object)
}
...
is_value.instrumentr_argument <- function(object) { # nolint
    .Call(C_instrumentr_argument_is_value, object)
}

#' @export
#' @rdname argument
as_value.instrumentr_argument <- function(object) { # nolint
    .Call(C_instrumentr_argument_as_value, object)
}

#' @export
#' @rdname argument
is_promise.instrumentr_argument <- function(object) { # nolint
    .Call(C_instrumentr_argument_is_promise, object)
}

#' @export
#' @rdname argument
as_promise.instrumentr_argument <- function(object) { # nolint
    .Call(C_instrumentr_argument_as_promise, object)
}
