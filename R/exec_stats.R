...
#' @export
#' @rdname exec_stats
get_minimum_time.instrumentr_exec_stats <- function(exec_stats) {
    .Call(C_instrumentr_exec_stats_get_minimum_time, exec_stats)
}

#' @export
#' @rdname exec_stats
get_maximum_time.instrumentr_exec_stats <- function(exec_stats) {
    .Call(C_instrumentr_exec_stats_get_maximum_time, exec_stats)
}

#' @export
#' @rdname exec_stats
get_average_time.instrumentr_exec_stats <- function(exec_stats) {
    .Call(C_instrumentr_exec_stats_get_average_time, exec_stats)
}

#' @export
#' @rdname exec_stats
get_total_time.instrumentr_exec_stats <- function(exec_stats) {
    .Call(C_instrumentr_exec_stats_get_total_time, exec_stats)
}

#' @export
#' @rdname exec_stats
get_execution_count.instrumentr_exec_stats <- function(exec_stats) {
    .Call(C_instrumentr_exec_stats_get_execution_count, exec_stats)
}
