...
create_tracer <- function(...) {
    ...
    tracer <- .Call(r_instrumentr_tracer_create)#, environment)
...
get_state.instrumentr_tracer <- function(object) {
    .Call(r_instrumentr_tracer_get_state, object)
}

#' @export
#' @rdname tracer
get_application.instrumentr_tracer <- function(object) { # nolint
    .Call(r_instrumentr_tracer_get_application, object)
}

#' @export
#' @rdname tracer
get_environment.instrumentr_tracer <- function(object, ...) { # nolint
    .Call(r_instrumentr_tracer_get_environment, object)
}

#' @export
#' @rdname tracer
get_callback.instrumentr_tracer <- function(tracer, event) {
    .Call(r_instrumentr_tracer_get_callback, tracer, event)
}
...
set_callback.instrumentr_tracer <- function(tracer, callback) { # nolint
    ...
    .Call(r_instrumentr_tracer_set_callback, tracer, callback)
...
has_callback.instrumentr_tracer <- function(tracer, event) { # nolint
    .Call(r_instrumentr_tracer_has_callback, tracer, event)
}

#' @export
#' @rdname tracer
remove_callback.instrumentr_tracer <- function(tracer, event) { # nolint
    .Call(r_instrumentr_tracer_remove_callback, tracer, event)
}

#' @export
#' @rdname tracer
is_active.instrumentr_tracer <- function(object) {
    .Call(r_instrumentr_tracer_is_active, object)
}

#' @export
#' @rdname tracer
is_enabled.instrumentr_tracer <- function(tracer) {
    .Call(r_instrumentr_tracer_is_enabled, tracer)
}
...
reinstate.instrumentr_tracer <- function(tracer) {
    .Call(r_instrumentr_tracer_reinstate, tracer)
}

#' @export
#' @rdname tracer
get_active_callback.instrumentr_tracer <- function(tracer) {
    .Call(r_instrumentr_tracer_get_active_callback, tracer)
}
