...
#define INSTRUMENTR_CALLBACK_TYPE_MAP_MACRO_1(MACRO, ARGUMENT)                     \
    ...
    MACRO(INSTRUMENTR_CALLBACK_APPLICATION_UNLOAD, application_unload, ARGUMENT)   \
    MACRO(INSTRUMENTR_CALLBACK_APPLICATION_ATTACH, application_attach, ARGUMENT)   \
    MACRO(INSTRUMENTR_CALLBACK_APPLICATION_DETACH, application_detach, ARGUMENT)   \
    ...
    MACRO(INSTRUMENTR_CALLBACK_BUILTIN_CALL_ENTRY, builtin_call_entry, ARGUMENT)   \
    MACRO(INSTRUMENTR_CALLBACK_BUILTIN_CALL_EXIT, builtin_call_exit, ARGUMENT)     \
    MACRO(INSTRUMENTR_CALLBACK_SPECIAL_CALL_ENTRY, special_call_entry, ARGUMENT)   \
    MACRO(INSTRUMENTR_CALLBACK_SPECIAL_CALL_EXIT, special_call_exit, ARGUMENT)     \
    MACRO(INSTRUMENTR_CALLBACK_CLOSURE_CALL_ENTRY, closure_call_entry, ARGUMENT)   \
    ...
    MACRO(INSTRUMENTR_CALLBACK_VARIABLE_DEFINITION, variable_definition, ARGUMENT) \
    MACRO(INSTRUMENTR_CALLBACK_VARIABLE_ASSIGNMENT, variable_assignment, ARGUMENT) \
