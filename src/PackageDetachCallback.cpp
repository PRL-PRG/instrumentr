...
SEXP PackageDetachCallback::class_ = nullptr;

void PackageDetachCallback::initialize() {
    class_ = Callback::create_class("instrumentr_package_detach_callback");
    R_PreserveObject(class_);
}

void PackageDetachCallback::finalize() {
    R_ReleaseObject(class_);
    class_ = NULL;
}

SEXP PackageDetachCallback::get_class() {
    return class_;
}

void PackageDetachCallback::invoke(SEXP r_context,
                                   SEXP r_application,
                                   SEXP r_package) {
