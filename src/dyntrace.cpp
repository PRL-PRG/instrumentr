...
dyntracer_t* instrumentr_dyntracer_create(instrumentr_tracer_t tracer) {
    ...
    dyntracer_set_builtin_entry_callback(dyntracer,
                                         instrumentr_trace_call_entry);
    dyntracer_set_builtin_exit_callback(dyntracer, instrumentr_trace_call_exit);
    dyntracer_set_special_entry_callback(dyntracer,
                                         instrumentr_trace_call_entry);
    dyntracer_set_special_exit_callback(dyntracer, instrumentr_trace_call_exit);
    dyntracer_set_closure_entry_callback(dyntracer,
                                         instrumentr_trace_call_entry);
    dyntracer_set_closure_exit_callback(dyntracer, instrumentr_trace_call_exit);
