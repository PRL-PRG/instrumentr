...
callback_type_info_t table[] = {
    /* INSTRUMENTR_CALLBACK_TRACING_ENTRY */
    {INSTRUMENTR_CALLBACK_TRACING_ENTRY, "tracing_initialization", 3},
    /* INSTRUMENTR_CALLBACK_TRACING_EXIT */
    {INSTRUMENTR_CALLBACK_TRACING_EXIT, "tracing_finalization", 3},
    ...
    {INSTRUMENTR_CALLBACK_BUILTIN_CALL_ENTRY, "builtin_call_entry", 6},
    /* INSTRUMENTR_CALLBACK_BUILTIN_CALL_EXIT */
    {INSTRUMENTR_CALLBACK_BUILTIN_CALL_EXIT, "builtin_call_exit", 6},
    /* INSTRUMENTR_CALLBACK_SPECIAL_CALL_ENTRY */
    {INSTRUMENTR_CALLBACK_SPECIAL_CALL_ENTRY, "special_call_entry", 6},
    /* INSTRUMENTR_CALLBACK_SPECIAL_CALL_EXIT */
    {INSTRUMENTR_CALLBACK_SPECIAL_CALL_EXIT, "special_call_exit", 6},
