...
callback_type_info table[] = {
    ...
    {INSTRUMENTR_CALLBACK_BUILTIN_CALL_ENTRY, "builtin_call_entry", 0},
    /* INSTRUMENTR_CALLBACK_BUILTIN_CALL_EXIT */
    {INSTRUMENTR_CALLBACK_BUILTIN_CALL_EXIT, "builtin_call_exit", 0},
    /* INSTRUMENTR_CALLBACK_SPECIAL_CALL_ENTRY */
    {INSTRUMENTR_CALLBACK_SPECIAL_CALL_ENTRY, "special_call_entry", 0},
    /* INSTRUMENTR_CALLBACK_SPECIAL_CALL_EXIT */
    {INSTRUMENTR_CALLBACK_SPECIAL_CALL_EXIT, "special_call_exit", 0},
    /* INSTRUMENTR_CALLBACK_CLOSURE_CALL_ENTRY */
    {INSTRUMENTR_CALLBACK_CLOSURE_CALL_ENTRY, "closure_call_entry", 0},
    /* INSTRUMENTR_CALLBACK_CLOSURE_CALL_EXIT */
    {INSTRUMENTR_CALLBACK_CLOSURE_CALL_EXIT, "closure_call_exit", 0},
    /* INSTRUMENTR_CALLBACK_EVAL_ENTRY */
    {INSTRUMENTR_CALLBACK_EVAL_ENTRY, "eval_entry", 0},
    /* INSTRUMENTR_CALLBACK_EVAL_EXIT */
    {INSTRUMENTR_CALLBACK_EVAL_EXIT, "eval_exit", 0},
    /* INSTRUMENTR_CALLBACK_GC_ALLOCATION */
    {INSTRUMENTR_CALLBACK_GC_ALLOCATION, "gc_allocation", 0},
    /* INSTRUMENTR_CALLBACK_VARIABLE_DEFINITION */
    {INSTRUMENTR_CALLBACK_VARIABLE_DEFINITION, "variable_definition", 0},
    /* INSTRUMENTR_CALLBACK_VARIABLE_ASSIGNMENT */
    {INSTRUMENTR_CALLBACK_VARIABLE_ASSIGNMENT, "variable_assignment", 0},
    /* INSTRUMENTR_CALLBACK_VARIABLE_REMOVAL */
    {INSTRUMENTR_CALLBACK_VARIABLE_REMOVAL, "variable_removal", 0},
    /* INSTRUMENTR_CALLBACK_VARIABLE_LOOKUP */
    {INSTRUMENTR_CALLBACK_VARIABLE_LOOKUP, "variable_lookup", 0}};
