...
SEXP ClosureCallExitCallback::class_ = nullptr;

void ClosureCallExitCallback::initialize() {
    class_ = Callback::create_class("instrumentr_closure_call_exit_callback");
    R_PreserveObject(class_);
}

void ClosureCallExitCallback::finalize() {
    R_ReleaseObject(class_);
    class_ = NULL;
}

SEXP ClosureCallExitCallback::get_class() {
    return class_;
}

/* TODO: wrap call, op, args and rho  */
/* TODO: add dyntrace_dispatch_t */
void ClosureCallExitCallback::invoke(SEXP r_context,
                                     SEXP r_application,
                                     SEXP r_call,
                                     SEXP r_op,
                                     SEXP r_args,
