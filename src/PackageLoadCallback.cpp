...
SEXP PackageLoadCallback::class_ = nullptr;

void PackageLoadCallback::initialize() {
    class_ = Callback::create_class("instrumentr_package_load_callback");
    R_PreserveObject(class_);
}

void PackageLoadCallback::finalize() {
    R_ReleaseObject(class_);
    class_ = NULL;
}

SEXP PackageLoadCallback::get_class() {
    return class_;
}

void PackageLoadCallback::invoke(SEXP r_context,
                                 SEXP r_application,
                                 SEXP r_package) {
