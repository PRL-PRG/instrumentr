...
model_type_info_t model_type_info_table[INSTRUMENTR_MODEL_TYPE_COUNT] = {
    ...
    {INSTRUMENTR_MODEL_TYPE_UNBOUND, "unbound", NULL},
    {INSTRUMENTR_MODEL_TYPE_MISSING, "missing", NULL},
    {INSTRUMENTR_MODEL_TYPE_NULL, "null", NULL},
    {INSTRUMENTR_MODEL_TYPE_EXTERNALPTR, "externalptr", NULL},
    {INSTRUMENTR_MODEL_TYPE_WEAKREF, "weakref", NULL},
    {INSTRUMENTR_MODEL_TYPE_BYTECODE, "bytecode", NULL},
    {INSTRUMENTR_MODEL_TYPE_S4, "s4", NULL},
    {INSTRUMENTR_MODEL_TYPE_CHAR, "char", NULL},
    {INSTRUMENTR_MODEL_TYPE_SYMBOL, "symbol", NULL},
    {INSTRUMENTR_MODEL_TYPE_LANGUAGE, "language", NULL},
    {INSTRUMENTR_MODEL_TYPE_DOT, "dot", NULL},
    {INSTRUMENTR_MODEL_TYPE_PAIRLIST, "pairlist", NULL},
    {INSTRUMENTR_MODEL_TYPE_LIST, "list", NULL},
    {INSTRUMENTR_MODEL_TYPE_EXPRESSION, "expression", NULL},
    {INSTRUMENTR_MODEL_TYPE_CHARACTER, "character", NULL},
    ...
    {INSTRUMENTR_MODEL_TYPE_COMPLEX, "complex", NULL},
    {INSTRUMENTR_MODEL_TYPE_RAW, "raw", NULL},
    {INSTRUMENTR_MODEL_TYPE_ENVIRONMENT, "environment", NULL},
    {INSTRUMENTR_MODEL_TYPE_BUILTIN, "builtin", NULL},
    {INSTRUMENTR_MODEL_TYPE_SPECIAL, "special", NULL},
    {INSTRUMENTR_MODEL_TYPE_CLOSURE, "closure", NULL},
