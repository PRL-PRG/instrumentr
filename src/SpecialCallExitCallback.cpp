...
SEXP SpecialCallExitCallback::class_ = nullptr;

void SpecialCallExitCallback::initialize() {
    class_ = Callback::create_class("instrumentr_special_call_exit_callback");
    R_PreserveObject(class_);
}

void SpecialCallExitCallback::finalize() {
    R_ReleaseObject(class_);
    class_ = NULL;
}

SEXP SpecialCallExitCallback::get_class() {
    return class_;
}

/* TODO: wrap call, op, args and rho  */
/* TODO: add dyntrace_dispatch_t */
void SpecialCallExitCallback::invoke(SEXP r_context,
                                     SEXP r_application,
                                     SEXP r_call,
                                     SEXP r_op,
                                     SEXP r_args,
