...
event_info_t table[INSTRUMENTR_EVENT_COUNT] = {
    ...
    {INSTRUMENTR_EVENT_BUILTIN_CALL_ENTRY, "builtin_call_entry", 7},
    {INSTRUMENTR_EVENT_BUILTIN_CALL_EXIT, "builtin_call_exit", 7},
    {INSTRUMENTR_EVENT_SPECIAL_CALL_ENTRY, "special_call_entry", 7},
    {INSTRUMENTR_EVENT_SPECIAL_CALL_EXIT, "special_call_exit", 7},
    {INSTRUMENTR_EVENT_CLOSURE_CALL_ENTRY, "closure_call_entry", 7},
    {INSTRUMENTR_EVENT_CLOSURE_CALL_EXIT, "closure_call_exit", 7},
