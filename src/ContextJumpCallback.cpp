...
SEXP ContextJumpCallback::class_ = nullptr;

void ContextJumpCallback::initialize() {
    class_ = Callback::create_class("instrumentr_context_jump_callback");
    R_PreserveObject(class_);
}

void ContextJumpCallback::finalize() {
    R_ReleaseObject(class_);
    class_ = NULL;
}

SEXP ContextJumpCallback::get_class() {
    return class_;
}
