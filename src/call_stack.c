...
int instrumentr_call_stack_get_jumped_frame_count(instrumentr_call_stack_t call_stack, void *pointer) {
    int size = instrumentr_call_stack_get_size(call_stack);

    for(int i = size - 1; i >= 0; --i) {

        instrumentr_frame_t frame = instrumentr_call_stack_get_frame(call_stack, i);
