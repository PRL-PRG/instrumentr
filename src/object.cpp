...
const char*
instrumentr_object_type_to_string(instrumentr_object_type_t object_type) {
    switch (object_type) {
    case INSTRUMENTR_TRACER:
        return "tracer";
        break;
    case INSTRUMENTR_CALLBACK:
        return "callback";
        break;
    case INSTRUMENTR_STATE:
        return "state";
        break;
    case INSTRUMENTR_APPLICATION:
        return "application";
        break;
    case INSTRUMENTR_PACKAGE:
        return "package";
        break;
    case INSTRUMENTR_FUNCTION:
        return "function";
        break;
    case INSTRUMENTR_CALL:
        return "call";
        break;
    case INSTRUMENTR_CALL_STACK:
        return "call_stack";
        break;
    case INSTRUMENTR_PARAMETER:
        return "parameter";
        break;
    case INSTRUMENTR_ARGUMENT:
        return "argument";
        break;
    case INSTRUMENTR_PROMISE:
        return "promise";
        break;
    case INSTRUMENTR_VALUE:
        return "value";
        break;
    case INSTRUMENTR_FRAME:
        return "frame";
        break;
    case INSTRUMENTR_CONTEXT:
        return "context";
        break;
    case INSTRUMENTR_EXEC_STATS:
        return "exec_stats";
        break;
    case INSTRUMENTR_ALLOC_STATS:
        return "alloc_stats";
        break;
    case INSTRUMENTR_OBJECT:
        return "object";
        break;
    }
}
...
void instrumentr_object_destroy(instrumentr_object_t object) {
    ...
    instrumentr_alloc_stats_t alloc_stats =
        instrumentr_state_get_alloc_stats(object->state);
...
void instrumentr_object_kill(void* object) {
    ...
    if (ref_count != 0) {
        ...
        instrumentr_alloc_stats_t alloc_stats =
            instrumentr_state_get_alloc_stats(obj->state);
