...
INSTRUMENTR_VALUE_DECLARE_API(INSTRUMENTR_MODEL_TYPE_BUILTIN, builtin)
INSTRUMENTR_VALUE_DECLARE_API(INSTRUMENTR_MODEL_TYPE_SPECIAL, special)
INSTRUMENTR_VALUE_DECLARE_API(INSTRUMENTR_MODEL_TYPE_CLOSURE, closure)
